...
/*Improve better product service */
...
const { findAllDraftsForShop, publishProductByShop,
    findAllPublishForShop, unPublishProductByShop, searchProductByUser } = require('../models/repository/product.repo')
...
class ProductFactory {
    ...
    // GET a list published product of shop
...
//Define sub-class for differrent product types Electronics
